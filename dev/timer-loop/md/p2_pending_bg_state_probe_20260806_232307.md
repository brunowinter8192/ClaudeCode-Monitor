# P2 — pending_bg_state probe run (2026-08-06T23:23:07.797634+00:00)
...
| project slug normalized from basename (Websearch -> websearch) | PASS |
| project slug normalized from basename (Monitor_CC -> monitor_cc) | PASS |
| empty project_path -> 'project' field omitted (backward-compat shape) | PASS |
| project_path omitted entirely (default '') -> 'project' field also omitted | PASS |
| real ProxyAddon.request() end-to-end stamps project from PROXY_PROJECT_PATH | PASS |
