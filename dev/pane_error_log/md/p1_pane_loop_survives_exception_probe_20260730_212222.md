# P1 — pane_error_log probe run (2026-07-30T21:22:22.256349+00:00)
...
| [main] loop terminated via _ProbeStop, not an unhandled crash | PASS |
| [main] survived past the crash iteration (>=2 ticks reached) | PASS |
| [main] injected exception logged with this pane's identifier | PASS |
| [main] full traceback recorded (Traceback... line present) | PASS |
| [main] finally: cleanup ran (disable_mouse + restore_terminal called) | PASS |
