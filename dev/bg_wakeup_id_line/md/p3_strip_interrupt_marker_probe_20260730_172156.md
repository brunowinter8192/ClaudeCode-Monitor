# P3 — strip_interrupt_marker probe run (2026-07-30T17:21:56.195443+00:00)
...
| tool-use wording (real, trailing '\n') -> '.' | PASS |
| tool-use wording (bare, no '\n') -> '.' | PASS |
...
| real corpus 180-char quote untouched | PASS |
...
| attribute_chunk(base wording) resolves to 'IM' | PASS |
| attribute_chunk(tool-use wording) resolves to 'IM' | PASS |
