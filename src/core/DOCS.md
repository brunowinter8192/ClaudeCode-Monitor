...
**Calls out:** `session_finder`, `jsonl`, `pane_error_log` (`log_pane_error`); lazy: `panes`, `workers`, `proxy_display`, `input.click_handler` (copy_to_clipboard, read_mouse_event with sentinel-aware return).
