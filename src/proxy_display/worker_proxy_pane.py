        ...
        if log_path:
            ...
            for entry in new_entries:
                ...
                if family not in _worker_proxy_acc_stripped:
                    _worker_proxy_acc_stripped[family] = {'system': {}, 'tools': {}, 'messages': {}, 'fields': {}, '_has_content_by_flow_id': {}}
                    _worker_proxy_acc_injected[family] = {'system': {}, 'tools': {}, 'messages': {}, 'fields': {}, '_has_content_by_flow_id': {}}
